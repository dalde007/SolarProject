...
function (_React$Component) {
  ...
  _createClass(Pet, [{
    key: "render",
    value: function render() // render should always be quick because it gets called so much
    {
      ...
      if (media && media.photos && media.photos.photo) {
        ...
        }); //keps only one size of the photo to display
      }
  ...
  return Pet;
}(_react.default.Component // in React, every "class" component must have a "render" method
...
var petfinder = (0, _petfinderClient.default)( //petfiner is the API client
{
  key: "f3a1da697665369c7e40d02fc7b809ad",
  secret: "eeb5ff8498067e05d40ab55f75a0760d"
});
...
function (_React$Component) {
  ...
  function App(props) // constructor always takes in props
  {
    var _this;

    _classCallCheck(this, App);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(App).call(this, props)); // calls React.Component's constructor and it passes the props up there
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() // life cycle method
    {
      var _this2 = this;
      ...
      petfinder.pet.find({
        output: "full",
        location: "Seatle, WA"
      }) // will request all animals up for adoption in the specified location
      .then(function (data) {
        var pets;
    ...
    value: function render() {
      ...
      // ])
      return (// same code as above but in JSX (HTML code within a JavaScript file)
        ...
        }, " Pet Finder!"), this.state.pets.map(function (pet) {
          var breed;
  ...
  return App;
}(_react.default.Component //App is the class (parent) component. Class components are "stronger" than function components
);

(0, _reactDom.render)(_react.default.createElement(App, null), document.getElementById('root')); // Running the program Prettier in the command line/terminal...
